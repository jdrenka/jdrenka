...
- Effective in-app integration of Machine Learning models, training ML models effectivley
- Data pipelining, data manipulation, application of data, data analysis
- CI/CD methods, deploying secure fullstack web apps to cloud services
